...
public class RequestAcquireSkill extends ClientPacket
{
	...
	protected void runImpl()
	{
		...
		// SUBCLASS certification skills can be opened remotely (e.g. Community Board) without a live trainer NPC;
		// trainer stays unused for that type in every downstream call (see showSkillList()).
		if ((_skillType != AcquireSkillType.SUBCLASS) && ((trainer == null) || !trainer.isNpc() || (!trainer.canInteract(player) && !player.isGM())))
		{
			return;
		}
